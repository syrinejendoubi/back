...
exports.createDiscipline = (req, res) => {
    ...
    .then(data => {
        ...
        res.status(500).send({
            message: err.message || "Something wrong while creating the discipline."
        });
    });
};
...
exports.findDiscipline = (req, res) => {
    ...
    .then(discipline => {
        ...
        return res.status(500).send({
            message: "Something wrong retrieving discipline with id " + req.params.disciplineId
        });
    });
};
...
exports.updateDiscipline = (req, res) => {
    ...
    .then(discipline => {
        ...
        return res.status(500).send({
            message: "Something wrong updating note with id " + req.params.disciplineId
        });
    });
};
...
exports.deleteDiscipline = (req, res) => {
    ...
    .then(discipline => {
        ...
        return res.status(500).send({
            message: "Could not delete discipline with id " + req.params.disciplineId
        });
    });
};